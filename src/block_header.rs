...
impl BlockHeader {
    pub fn new(version:i32,previous_block_header_hash: [u8; 32],merkle_root_hash: [u8; 32],time: u32,n_bits: u32,nonce: u32,)-> BlockHeader{
        BlockHeader {version,previous_block_header_hash,merkle_root_hash,time,n_bits,nonce}
    }
